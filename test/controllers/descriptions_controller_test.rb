...
class DescriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create description" do
    assert_difference("Description.count") do
      post descriptions_url, params: { description: { article_id: @description.article_id, content: @description.content } }
    end
  ...
  test "should update description" do
    patch description_url(@description), params: { description: { article_id: @description.article_id, content: @description.content } }
